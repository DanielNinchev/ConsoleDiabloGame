...
namespace ConsoleDiablo.App.Entities.Commands
{
    public class SignUpCommand : IMenuCommand
    {
        ...
        public SignUpCommand(IAccountService accountService, IMenuFactory menuFactory)
        {
        ...
        public IMenu Execute(params string[] args)
        {
            ...
            bool success = this.accountService.TryCreatingAnAccount(accountName, password);
